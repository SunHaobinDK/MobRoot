...
public class AdvanceWindowAppPhotosAdapter extends BaseAdapter {
	private Context mContext;
	private List<String> mDatas;
	private LayoutInflater mInflater;

	public AdvanceWindowAppPhotosAdapter(Context context, List<String> datas) {
		mContext = context;
		mDatas = datas;
	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(null == convertView) {
			...
			convertView = mInflater.inflate(R.layout.advance_window_photo_item, null);
			holder = new Holder();
