...
public class UploadDeviceRequest<T> extends AMRequest<T> {
	...
	public void start(Object... args) {
		try {
			...
			jsonObject.put(AMConstants.SP_USER_AGENT, sp.getString(AMConstants.SP_USER_AGENT, null));
			...
			jsonObject.put(AMConstants.SP_CLIENT_VERSION, sp.getString(AMConstants.SP_CLIENT_VERSION, null));
