...
public class ATLocation implements LocationListener {
	
	private static ATLocation sLocationUtil;
	private LocationManager mLocationManager;
	private Criteria mCriteria;
	private ATLocationListener mListener;
	...
	public static ATLocation getInstance() {
		if(null == sLocationUtil) {
			synchronized (ATLocation.class) {
				if(null == sLocationUtil) {
					sLocationUtil = new ATLocation();
				}
			}
		}
	...
	public void getCurrentLocation(ATLocationListener listener) {
		mListener = listener;
	...
	private class RequestLocation implements Runnable {
		...
		public void run() {
			...
			mLocationManager.requestLocationUpdates(mProvider, 0, 0, ATLocation.this);
		}
	}
	
	public interface ATLocationListener {
		public void onLocationChanged(Location location);
	}
}
